...
$(function() {
    ...
    var setting = {
        counter: {
            lastDate: "10/08/2019 12:00:00", // target date settings, 'MM/DD/YYYY HH:MM:SS'
            timeZone: null
        }
    };
    ...
    // 13. typed text
    $(".typed-title").typed({
        /*strings: ["philosophy.", "epistemology.", "phenemology.",
        "logic.", "aesthetics.", "ethics."],*/
        strings: ["computer science.","cognitive science.","algorithms.",
        "data structures.","philosophy.","psychology.", "artificial intelligence.", 
      "neuroscience."],
        typeSpeed: 35,
        backDelay: 4500,
        loop: true
